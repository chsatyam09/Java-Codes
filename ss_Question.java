...
// // This line represents the signature of a method named valueEqualToIndex in Java, which takes an integer array (arr) and an integer (n) as parameters and returns an ArrayList<Integer>.

// // Here's an explanation of each part:

// // Access Modifier (static): This keyword is an access modifier that indicates the method belongs to the class rather than an instance of the class. It allows the method to be called without creating an instance of the class.

// // Return Type (ArrayList<Integer>): This indicates the type of the value that the method will return. In this case, the method will return an ArrayList containing integers (Integer).

// // Method Name (valueEqualToIndex): This is the name given to the method. It is used to identify and call the method in other parts of the code.

// // Parameters (`int arr[], int n)::** These are the values that the method accepts as input. In this case, the method takes two parameters:
...
// public class ss_Question {
//     public static int majority(int arr[],int x) {
      

//         for (int i = 0; i < arr.length; i++) {

//         int count =0 ; // int count = 1 ;  (int j = i+1; j < arr.length; j++)
