...
// row = 3 = i ;
// column = 2 = j ;
// outer for loop i.e. i is used to control Rows ;
// inner for loop i.e. j is used to control Columns ;
...
// another method // JAB VALUES NHI PATA HAI 
...
// public boolean searchInMatrix(int[][] matrix, int x) {
